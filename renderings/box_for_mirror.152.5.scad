...
module full_box(){
    difference(){
        ...
        create_box_outline(sidewall_offset = -5,cut_corner_offset=0, vertical_mod = ((height) /3 - middle_lip_height/3 - 2)- front_plexi_inset/2, height_mod = middle_lip_height, radius=2, radius2=1, leds = true);
...
full_box();
translate([0,0,1]) bottom_glass_spacer();
